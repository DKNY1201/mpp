...
public class Main {
    ...
    static Function<Integer, Integer> absInt = (Integer x) -> Math.abs(x);

	public static void ordering1(List<Integer> list) {
		System.out.println(list.stream()
                .sorted(Comparator.comparing(absInt).thenComparing(x -> x))
	...
	//Using this ordering, this method sorts the list as part of 
	//a stream pipeline, and prints to the console
    static Function<String, String> reverseStr = (String str) -> {
	...
	public static void ordering2(List<String> words) {
		System.out.println(words.stream()
                .sorted(Comparator.comparing(reverseStr))
                .collect(Collectors.toList()));
	}
